...
function AvatarImageWithLoader(props: React.ComponentProps<typeof AvatarImage>) {
  ...
  return (
    <>
      ...
      {loading && (
        <div className="absolute inset-0 size-full dark:bg-theme-mine-shaft-dark">
  ...
  return (
    <div className="relative h-auto w-full">
      <Avatar className="relative h-0 w-full overflow-hidden rounded-3xl pt-[56.25%] sm:h-[400px] sm:pt-0">
        ...
        />
        <AvatarFallback className="absolute left-0 top-0 size-full capitalize rounded-none bg-gradient-to-br from-slate-900 to-zinc-700 text-3xl">
  ...
  return (
    <Avatar className="relative z-[2] -mt-36 ml-6 size-32 sm:-mt-44 sm:ml-12 sm:size-44">
      <AvatarImageWithLoader
        ...
        alt={user?.username}
      />
      <AvatarFallback className="border capitalize border-gray-200 bg-theme-mine-shaft-dark dark:border-theme-mine-shaft dark:bg-theme-mine-shaft-dark">
