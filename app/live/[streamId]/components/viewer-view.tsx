  ...
  return (
    ...
    >
      {account && src ? (
        <Player.Root src={src}>
          <Player.Container>
            <Player.Video title={stream.title} className="w-full h-full" />
...
export const PlayerLoading = ({
  ...
  <div className="aspect-video relative flex w-full flex-col-reverse gap-3 overflow-hidden rounded-sm bg-white/10 px-3 py-2">
      ...
      <Popover>
        ...
        >
          <div className="flex flex-col gap-2">
            ...
            <Player.LiveIndicator matcher={false} className="flex flex-col gap-2">
              <label className="text-xs font-medium text-white/90" htmlFor="speedSelect">
                Playback speed
              </label>
              <Player.RateSelect name="speedSelect">
                ...
                <Player.SelectPortal>
                  <Player.SelectContent className="overflow-hidden rounded-sm bg-black">
            ...
            <div className="flex flex-col gap-2">
              <label className="text-xs font-medium text-white/90" htmlFor="qualitySelect">
                Quality
              </label>
                ...
                <Player.SelectPortal>
                  <Player.SelectContent className="overflow-hidden rounded-sm bg-black">
                    <Player.SelectViewport className="p-[5px]">
                      <Player.SelectGroup>
                        <VideoQualitySelectItem value="auto">Auto (HD+)</VideoQualitySelectItem>
