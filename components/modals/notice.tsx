...
export function NoticeModal() {
  ...
  return (
    <div className="fixed left-0 top-0 z-[1000] grid size-full place-items-center">
      {/* content */}
      <div className="relative z-10 flex size-auto max-w-full flex-col items-center justify-center gap-10 rounded-2xl bg-theme-background p-10 text-center sm:max-w-xl">
